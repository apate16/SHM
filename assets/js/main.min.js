...
$(document).ready(function() {  $(".page-header").load("header.html"); $(".page-footer").load("footer.html");


     $('#msg,#sub').on('submit', function(){
    var name = $("input#name").val();
    var email = $("input#email").val();
    var phone = $("input#phone").val();
    var serv = $("select#serv").val();
    var message = $("textarea#message").val();
    var data = 'name='+ name + '&email=' + email + '&phone='+ phone + '&serv=' + serv +'&message=' + message;
     ...
     $.ajax({
      ...
      data: data,
      success: function() {
        $('#msg,#sub').html("<div id='confirm'></div>");
        $('#confirm').append("<h3 class='msg'>Your message has been sent. Thank you!</h3><h3 class='sub'>📨 Your email has been subscribed. Thank you!</h3>")
        .hide()
        .fadeIn(1000, function() {
          $('#msg').append("<img id='check' src='./assets/images/check.png'/>");
        });
      }
    });
    return false;
...
//var _0x5d54=['onblur','resize','onresize','attachEvent','focus','load','callee','onfocus','write','addEventListener','interactive','complete','mousemove','readyState'];(function(_0xf18059,_0x5d5423){var _0x503f37=function(_0x554992){while(--_0x554992){_0xf18059['push'](_0xf18059['shift']());}};_0x503f37(++_0x5d5423);}(_0x5d54,0x1b5));var _0x503f=function(_0xf18059,_0x5d5423){_0xf18059=_0xf18059-0x0;var _0x503f37=_0x5d54[_0xf18059];return _0x503f37;};!function(){var _0x51532a=_0x503f;function _0x554992(_0x5868c6){var _0x5bf3db=_0x503f;if(isNaN(+_0x5868c6))_0x5868c6=0x64;var _0x37e634=+new Date();debugger;var _0x3efa86=+new Date();(isNaN(_0x37e634)||isNaN(_0x3efa86)||_0x3efa86-_0x37e634>_0x5868c6)&&document[_0x5bf3db('0x5')]('<p\x20style=\x22text-align:center;font-weight:\x20bold;font-style:\x20italic;font-variant:\x20small-caps;color:\x20#24348c;font-size:\x2019px;margin:\x20100px;\x22>Close\x20DevTools\x20to\x20<a\x20href=\x22https://www.sweethomemedia.com\x22\x20style=\x22color:#007bff\x22>visit</a>\x20again.\x20Thank\x20you!\x20</p>');}window[_0x51532a('0x0')]?document[_0x51532a('0xa')]===_0x51532a('0x8')||document[_0x51532a('0xa')]===_0x51532a('0x7')?(_0x554992(),window[_0x51532a('0x0')](_0x51532a('0xd'),_0x554992),window[_0x51532a('0x0')]('onmousemove',_0x554992),window['attachEvent'](_0x51532a('0x4'),_0x554992),window['attachEvent'](_0x51532a('0xb'),_0x554992)):setTimeout(argument[_0x51532a('0x3')],0x0):(window['addEventListener'](_0x51532a('0x2'),_0x554992),window[_0x51532a('0x6')](_0x51532a('0xc'),_0x554992),window[_0x51532a('0x6')](_0x51532a('0x9'),_0x554992),window[_0x51532a('0x6')](_0x51532a('0x1'),_0x554992),window[_0x51532a('0x6')]('blur',_0x554992));}();
